 ...
 */
int *totalpalette; /* 32*32*32 entries, race_alloc_memory() */
...
MYSPRITEDEF *mySprPri40, *mySprPri80, *mySprPriC0; /* 3 x 39 KB, race_alloc_sprites() */

void race_alloc_sprites(void *p40, void *p80, void *pC0)
{
   mySprPri40 = p40; mySprPri80 = p80; mySprPriC0 = pC0;
}
