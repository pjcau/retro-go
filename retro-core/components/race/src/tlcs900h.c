...
//
//
// there don't seem to be any direct calls into the ngp_bios_flag. The way ngp_bios_flag calls seem to be
...
// execute a ngp_bios_flag function
static INLINE int doBios(unsigned char biosNr)
{
    switch (biosNr)
    {
        ...
        *cregsB[1] = 0;   // ld a,00
        ...
        case 0x0e:
        return VECT_GEMODESET(0x10);  // Implementation wrong in ngpc ngp_bios_flag???, always set to color
        case 0x14:
        *cregsB[1] = 1;   // ld a,01
        break;
        case 0x17:
...
int (*decode_tableC8[256])() =
    {
        ...
        udef,  udef,  ngp_bios_flag,  udef,  djnzB,  udef,  udef,  udef,
