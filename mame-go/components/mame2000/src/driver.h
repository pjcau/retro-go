...
#ifdef MAMEGO /* driver tables are const so they live in flash, not in internal RAM */
#define MAMEGO_CONST const
#else
#define MAMEGO_CONST
#endif

#define GAME(YEAR,NAME,PARENT,MACHINE,INPUT,INIT,MONITOR,COMPANY,FULLNAME)	\
extern MAMEGO_CONST struct GameDriver driver_##PARENT;	\
MAMEGO_CONST struct GameDriver driver_##NAME =			\
{											\
	__FILE__,								\
	&driver_##PARENT,						\
	#NAME,									\
