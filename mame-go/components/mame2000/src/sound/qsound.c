...
/* QSound output-stage post-processing: firmware-derived pan-mix
 ...
 * BSD-3-Clause license; see the project's LICENSE for the full text.
 *
		...
		case 8:
			{
			   ...
			   qsound_channel[ch].pan_index = pandata;
